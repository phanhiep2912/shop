	...
	public String Checkout(ModelMap model, HttpSession session) {
		...
		try {
			mailer.send("tckietct@gmail.com", user.getEmail(), "Đặt hàng thành công",		
					"Cảm ơn bạn đã đặt hàng <br>Tổng số tiền bạn phải trả là: "+"$"+price+" .<br>Món hàng của bạn đang được chuẩn bị. Chúng tôi sẽ liên hệ với bạn sớm nhất!<br><br> Chân thành cảm ơn quý khách.");
