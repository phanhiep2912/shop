...
<body>
	...
	<div class="container">
		<div class="account">
			...
			<br>
			<span ><u style="color:green">Họ và tên:</u> ${sessionScope.user.name}</span><br><br>
			<span><u style="color:green">Email:</u> ${sessionScope.user.email}</span><br><br>
			<span><u style="color:green">Số điện thoại:</u> ${sessionScope.user.phone}</span><br><br>
			<span><u style="color:green">Địa chỉ:</u> ${sessionScope.user.address}</span><br><br><br><br>
			<!--  
				<form>
				<div>
