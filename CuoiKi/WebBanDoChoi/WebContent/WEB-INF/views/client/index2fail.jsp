		...
		<div class="slides" id="slides">
			...
			<div class="slide">
				...
				<div class="caption">
					...
					<p>
						Ô tô đồ chơi - Hiện đang bán với giá <span
			...
			<div class="slide">
				...
				<div class="caption">
					...
					<p>
						Rubik - Hiện đang bán với giá <span
			...
			<div class="slide">
				...
				<div class="caption">
					...
					<p>
						Mô hình động vật - Hiện đang bán với giá<span class="price">$400</span>
					</p>
				</div>
				<!-- end of .caption -->
			</div>
		...
		<div class="content">
			...
			<div class="content-middle">
				...
				<div class="content-middle-in">
					<ul id="flexiselDemo1">
						<li><img src="${pageContext.request.contextPath}/resources/client/images/1.jpg" /></li>
