    ...
    <body>
        ...
        <div class="header-main">
            <div class="header-left">
                <div class="logo-name">
                    <a href="${pageContext.request.contextPath}/trang-chu.htm"> <h1>Toy Store</h1> 
                    ...
                    <ul class="nofitications-dropdown">
                        <li class="dropdown head-dpdn">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/admin/images/pi.jpg" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Hiệp Lô Lô</p>
                                            <p><span>18 phút trước</span></p>
                                        </div>
                                        <div class="clearfix"></div>	
                                    </a></li>
                                <li class="odd"><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/admin/images/7b.jpg" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Khanh Phạm </p>
                                            <p><span>10 giờ trước</span></p>
                                        </div>
                                        <div class="clearfix"></div>	
                                    </a></li>
