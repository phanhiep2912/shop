							...
							<div class="tab-pane active text-style" id="tab1">
								<div class="mailbox-border">
									...
									<table class="table tab-border">
										<tbody>
											<tr>
												<td class="hidden-xs" style="width: 180px;"><b>Tên sản phẩm</b></td>
												<td class="hidden-xs" style="width: 100px;"><b>Loại: </b>
												</td>
												<td style="text-align: left; width: 80px;"><b>Giá: </b>
												</td>
												<td style="text-align: center; width: 50px;"><b>Định lượng</b>
												</td>
												<td style="text-align: center; width: 200px;"><b>Hình ảnh</b>
												</td>
